...
List<CovidCountryItem>, private val listener : (CovidCountryItem)-> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ViewHolder(context, LayoutInflater.from(context).inflate(R.layout.covid_country_item,
            parent, false))
    ...
    class ViewHolder(val context : Context, override val containerView : View) :
        ...
        fun bindItem(item: CovidCountryItem, listener: (CovidCountryItem) -> Unit) {
            ...
            txtPositif.text = "Confirmed : " + item.attributes.confirmed.toString()
            txtMeninggal.text = "Deaths : " + item.attributes.deaths.toString()
            txtSembuh.text = "Recovered : " + item.attributes.recovered.toString()
